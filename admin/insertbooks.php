...
shippingCharge,bookStatus, bookAvailability,status,bookFeatured,coverImage) VALUES('$categoryName','$subcategoryName','".$_SESSION['bookToken']."',
'$title','$brief','$authorName','$bookPrice','$bookPriceBeforeDiscount','$shippingCharge','$bookStatus','$bookAvailability',
'$status','$bookFeatured','$coverImage')");
	...
	<!--***********************************END ADD DELETE CATEGORY MSG*******************************************************-->
        ...
        <div class="adminform_div">
				...
				<div class="adminform_div">
					...
					<input type="text" name="bookFeatured"  placeholder="Enter book Featured" class="adminform_input" required>
				</div>

...
<center>
	<div class="container">
		...
		<form method="post">
			<h2>Empty Table:</h2>
			<button type="submit" name="truncateManageProductsTable" class="adminform_btn">Empty Table</button>
		</form>
</div>
</center>
...
JOIN subcategory ON subcategory.subcategoryName=books.subCategoryName");
$cnt=1;

    ...
    <div class="container">
            <div class="form-div">
                <form action="signup-user.php" class="form" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        <textarea class="form-input" type="text" name="shippingAddress" placeholder="shipping Address" required>
                        </textarea>
                    </div>
                    <div class="form-group">
                        <input class="form-input" type="text" name="shippingState" placeholder="shipping State" required>
                    </div>

                    <div class="form-group">
                        <input class="form-input" type="text" name="shippingCity" placeholder="shipping City" required>
                    </div>

                    <div class="form-group">
                        <input class="form-input" type="text" name="shippingPinCode" placeholder="shipping Pin Code" required>
                    </div>

                    <div class="form-group">
                      <label for="donation">donation coupon</label><br>
                        <select class="form-input" type="text" name="donationCoupon" placeholder="donationCoupon" required>
